...
//
//     final modelForUpdateApi = modelForUpdateApiFromJson(jsonString);

import 'dart:convert';

ModelForUpdateApi modelForUpdateApiFromJson(String str) => ModelForUpdateApi.fromJson(json.decode(str));

String modelForUpdateApiToJson(ModelForUpdateApi data) => json.encode(data.toJson());

class ModelForUpdateApi {
  ModelForUpdateApi({
    this.success,
    this.responseCode,
    this.message,
  ...
  factory ModelForUpdateApi.fromJson(Map<String, dynamic> json) => ModelForUpdateApi(
