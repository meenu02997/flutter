...
final md.Color defaultColor = HexColor('#b4b4b4');

final md.Color defaultOnSelectColor = HexColor('#1a2c2e');
...
class LabelStyle {
  ...
  getTextStyle() {
    ...
    return md.TextStyle(color: defaultColor, fontSize: 11.0);
  }
  ...
  getOnSelectTextStyle() {
    ...
    return md.TextStyle(color: defaultOnSelectColor, fontSize: 11.0);
  }
}
      ...
      child: md.Padding(
          ...
          child: md.Column(
              ...
              children: <md.Widget>[
                ...
                SizedBox(height: 5,),
                label != null
                    ? md.Text(label, textAlign: md.TextAlign.center,style: textStyle)
                    : md.Container()
              ])),
