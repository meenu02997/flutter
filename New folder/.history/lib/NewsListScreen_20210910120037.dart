...
class _NewsListScreenState extends State<NewsListScreen> {
  ...
  Future<Welcome> fetch() async {
    ...
    if (response.statusCode == 200) {
      ...
      print(response.data);
      setState(() {
        NewsSearch = w = Welcome.fromJson(response.data);
        circular = false;
      });
    }
    return w;
  ...
  Future<Welcome> searchFetch(String val) async {
    ...
    if (response.statusCode == 200) {
      ...
      print(response.data);
      setState(() {
        NewsSearch = Welcome.fromJson(response.data);
        circular = false;
      });
    }
    return NewsSearch;
  ...
  String valueChoose;
  List Listitem = ['Popular', 'Newest', 'Oldest'];
  ...
  void _tripEditModelBottamSheet2(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (BuildContext mc) {
          return Padding(
            padding: const EdgeInsets.only(
              left: 8.0,
              right: 8.0,
