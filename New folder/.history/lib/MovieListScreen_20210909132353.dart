...
class _MovieListScreenState extends State<MovieListScreen> {
  ...
  Future<Welcome> fetch() async {
    Response response = await dio.get(
        "https://newsapi.org/v2/everything?q=tesla&from=2021-08-09&sortBy=publishedAt&apiKey=b4ad155890b44f55b4f14bdbb02de7e6"
  ...
  Future<Welcome> searchFetch(String val) async {
    Response response = await dio
        .get("https://newsapi.org/v2/everything?q=tesla&from=2021-08-09&sortBy=publishedAt&apiKey=b4ad155890b44f55b4f14bdbb02de7e6"
      //     "https://api.themoviedb.org/3/search/movie?", queryParameters: {
      // "api_key": "50e4bdab411de06d008a322b7c13e290",
      // "language": "en-US",
