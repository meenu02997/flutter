...
enum BottomSheetActions { ACTION_CLOSED, ACTION_OPENED }
...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return BoxConstraints(
      ...
      minHeight: 0.0,
      maxHeight: isScrollControlled ? constraints.maxHeight : constraints.maxHeight,
    );
  }
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  @override
  Color get barrierColor => AppColors.black80;
  ...
  Widget buildPage(
    ...
    Widget bottomSheet = MediaQuery.removePadding(
      context: context,
      removeTop: true, //Changed this line
...
/// this method.
///
/// Thebottom sheet becomes a [LocalHistoryEntry] for the enclosing
