var productMaster = [
  ...
  {id:'B408',name:'Milk', category:'Chocloate', price:8, quantity:15},
  {id:'A354',name:'Dairy Milk', category:'Chocloate', price:30, quantity:4}];

productMaster.push({id:'B003',name:'Sprite', category:'Soft  Drink', price:16, quantity:5, type:'Food'});
console.log(productMaster);
// console.log('product is :-  ' ,maxProd);
// console.log('{name: ',maxProd.name+' , '+ 'price: ',maxProd.price+'}');
