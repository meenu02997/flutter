...
class _HomeState extends State<CreateNewUser> {
  ...
  final TextEditingController _ConfrimPassController =
                ...
                child: ListView(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.network(
                        "https://media.istockphoto.com/photos/button-on-computer-keyboard-picture-id1146311489?b=1&k=6&m=1146311489&s=170667a&w=0&h=GFacsiyaQMEfptGYNQXBKwePKsPzpnAX0dJRGYMfuy0=",
                        fit: BoxFit.cover,
                      ),
                    ),
                    Container(
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                validator: (value) {
                                  ...
                                  if (_ConfrimPassController.text !=
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            RaisedButton(
                              ...
                              onPressed: () async {
                                //var PlainText = _passController.text.toString;
  ...
  //
  //   final String encryptedS = await cryptor.encrypt(password, Key);
  //   print(encryptedS);
  //
  // }
}
